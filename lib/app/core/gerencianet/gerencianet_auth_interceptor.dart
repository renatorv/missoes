...
class GerencianetAuthInterceptor extends Interceptor {
  ...
  Future<String> _login() async {
    ...
    final headers = {
      'authorization': 'Basic ${_getAutorization()}',
      'content-type': 'application/json',
    };
  ...
  String _getAutorization() {
    final clientId = env['GERENCIANET_CLIENT_ID'] ?? env['gerencianetClientId'] ?? '';
    final clientSecret = env['GERENCIANET_CLIENT_SECRET'] ?? env['gerencianetClientSecret'] ?? '';
