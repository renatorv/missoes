...
class GerencianetCallbackViewModel {
  ...
  factory GerencianetCallbackViewModel.fromMap(Map<String, dynamic> map) {
    return GerencianetCallbackViewModel(
      pix: List<GerencianetPixViewModel>.from(map['pix']?.map((x) => GerencianetPixViewModel.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory GerencianetCallbackViewModel.fromJson(String source) => GerencianetCallbackViewModel.fromMap(json.decode(source));
}
